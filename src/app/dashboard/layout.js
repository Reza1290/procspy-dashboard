...
export default function DashboardLayout({ children }) {
    return (
        <section className="flex w-full bg-gradient-to-r from-black to-slate-950">
            <div className="flex flex-col justify-between items-center max-w-[4.25rem] py-4 h-screen w-full border-r border-white/10 bg-gradient-to-b from-black to-slate-950">
                <div className="flex flex-col items-center p-2 gap-8">
                    <div className="w-10 bg-white rounded-md h-10">

                    </div>
                    <div className="flex flex-col items-center gap-3 w-full">
                        <div className="flex w-full fill-white/50  hover:bg-white/10 p-2.5 rounded-md max-w-10 max-h-10 h-10">
                            ...
                            <div className="flex flex-col w-full justify-between gap-6">
                                <div className="flex flex-col gap-4 overflow-y-scroll w-full">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="bg-white/10 rounded-lg text-sm px-2 max-w-72 py-0.5">please turn around your camera make sure the sorrounding is appear</p>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <p className="text-xs">from <span className="font-semibold">you&nbsp;</span>to <span className="font-semibold">user-6541bca123453221114</span></p>
                                        <p className="bg-white/10 rounded-lg text-sm px-2 max-w-72 py-0.5">please turn around your camera make sure the sorrounding is appear</p>
                                ...
                                <div className="bg-white/10 border border-white/10 rounded-lg max-h-12 h-full flex justify-center p-1 gap-2">
