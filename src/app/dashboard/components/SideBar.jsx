...
export default function SideBarLayout({ children }) {
    ...
    const handleUsersSidebarToggle = () => {
    ...
    return (
        <section className="flex w-full bg-gradient-to-r from-black to-slate-900/70">
            <div className="z-10 flex flex-col justify-between items-center max-w-[4.25rem] py-4 h-screen w-full border-r border-white/15 bg-gradient-to-b from-black to-slate-950">
                <div className="flex flex-col items-center p-2 gap-8">
                    <div className="w-10 bg-white rounded-md h-10">

                    </div>
                    <div className="flex flex-col items-center gap-3 w-full">
                        <div onClick={handleHomeSidebarToggle} className="flex w-full fill-white/50  hover:bg-white/15 p-2.5 rounded-md max-w-10 max-h-10 h-10">
                        ...
                        </div>
                        {
                            roomId  != undefined && <>
                                ...
                                <div className="w-full fill-white/50  hover:bg-white/15 p-3 rounded-md max-w-10 max-h-10 flex h-10">
                ...
                <div className="flex flex-col w-full p-2 items-center gap-2 ">
                    <div onClick={()=>(
                        router.push('/dashboard/proctored_users')
                        )} className="w-full fill-white/50  hover:bg-white/15 p-2.5 rounded-md max-w-10 max-h-10 h-full">
                    ...
                    <div className="w-full fill-white/50  hover:bg-white/15 p-2.5 rounded-md max-w-10 max-h-10 h-full">
