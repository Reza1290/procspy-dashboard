...
const RoomInput = () => {
    ...
    return (
        <div className="flex gap-4">
            ...
            <button onClick={() => router.push(`/dashboard/room/${roomCode}`)} className="bg-slate-900 border border-white/10 aspect-square rounded-lg w-full max-w-11 p-3 fill-white">
