...
export default function Page() {
    ...
    return <div className="flex justify-between h-screen">
        ...
        <div className="flex justify-center w-full items-center dark:bg-gradient-to-b dark:from-black dark:to-slate-950">
            <form onSubmit={onSubmit} className="flex flex-col items-center gap-5 max-w-80 w-full">
                <Image alt="lowo" width={100} height={100} className="bg-white p-1 rounded-md" src={'/image/logo.png'}></Image>

                <h1 className="text-4xl font-bold">Login</h1>
                <h2 className="dark:text-white/70">Login with your designated Account</h2>
